...
var showAlert = function showAlert(type, msg) {
  var markup = "<div class=\"alert\">".concat(msg, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.hideAlert)(); // location.assign(window.location.href.split('?')[0])
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('err', 'username or password is wrong!');
            setTimeout(function () {
              (0, _alerts.hideAlert)();
            }, 5000);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context3.t0.response.data.message || 'Something is wrong!');
            setTimeout(function () {
              (0, _alerts.hideAlert)();
            }, 3000);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgetPassword.js":[function(require,module,exports) {
"use strict";
...
var forgetPassword = /*#__PURE__*/function () {
  ...
  return function forgetPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var displayMap = function displayMap(mapLocation) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFtaWRzd2VyMiIsImEiOiJja2xkNmg5NGsxNzRrMnBwOXl3bjB6cmE5In0.aBDZyhMRYx5ukx1D6laI4Q';
  ...
  new mapboxgl.Marker({
    element: mapEl,
    anchor: 'bottom'
  }).setLngLat(mapLocation.coordinates).addTo(map);
  bounds.extend(mapLocation.coordinates);
  map.fitBounds(bounds);
};

exports.displayMap = displayMap;
},{}],"updateUser.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"writeReview.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.writeReview = void 0;
...
var writeReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, urls) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function writeReview(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.writeReview = writeReview;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteReview.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            _context.prev = 6;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'Something is wrong!');
            setTimeout(function () {
              (0, _alerts.hideAlert)();
            }, 3000);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"writePost.js":[function(require,module,exports) {
"use strict";
...
var writePost = /*#__PURE__*/function () {
  ...
  return function writePost(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.writePost = writePost;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"editPost.js":[function(require,module,exports) {
"use strict";
...
var editPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, urls) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deletePost.js":[function(require,module,exports) {
"use strict";
...
var _writeReview = require("./writeReview");

var _deleteReview = require("./deleteReview");

var _writePost = require("./writePost");

var _editPost = require("./editPost");
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.querySelector('#signup-password-confirm').value;
    (0, _login.signup)(name, email, password, passwordConfirm); // name.innerText = ''
    // email.innerText = ''
    // password.innerText = ''
...
var forgetButton = document.querySelector('.forget-password-text');
var forgetPasswordForm = document.querySelector('.forget-password-form');
...
forgetButton.addEventListener('click', function (e) {
  e.preventDefault();
...
var resetPasswordForm = document.querySelector('.reset-user-password');
...
var mapBox = document.querySelector('.post-map');

if (mapBox) {
  var mapLocation = JSON.parse(mapBox.dataset.location);
  (0, _mapbox.displayMap)(mapLocation);
} // --------------------------------------------------
// ====================================review stars


var rates = document.querySelectorAll('.post-review-rate');

if (rates) {
  rates.forEach(function (rate) {
    var rateLength = Number(rate.innerText);
    rate.innerText = '';
    var img;
...
var logOutBtn = document.querySelector('#loggout');
...
// ======> name and email
var userInformation = document.querySelector('#settings-user-information');

if (userInformation) {
  userInformation.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    (0, _updateUser.updateData)(form, 'data');
  });
} // =====> password


var userPasswordForm = document.querySelector('#settings-user-password'); // password passwordConfirm and passwordCurrent should be the same variable our API accepts!
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              passwordCurrent = document.querySelector('#settings-user-current-password').value;
              password = document.querySelector('#settings-user-new-password').value;
              passwordConfirm = document.querySelector('#settings-user-new-password-confirm').value;
              _context.next = 6;
              return (0, _updateUser.updateData)({
            ...
            case 6:
              '', _readOnlyError("passwordCurrent");
              '', _readOnlyError("password");
              '', _readOnlyError("passwordConfirm");
...
var container = document.querySelectorAll('.slider-image-span');
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    var textarea = data.get('comment');
    var stars = data.get('stars');

    if (!stars) {
      stars = 5;
    }

    (0, _writeReview.writeReview)(textarea, Number(stars), window.location.href);
  });
} // delete reviews


var deleteReviews = document.querySelectorAll('.delete-review');

if (deleteReviews) {
  deleteReviews.forEach(function (e) {
    e.addEventListener('click', function (e) {
      e.preventDefault();
      var commentId = e.target.getAttribute('data-review-id');
      (0, _deleteReview.deleteReview)(commentId);
    });
  });
} //  === write a post


var writePostForm = document.querySelector('.write-post-form');
...
if (writePostForm) {
  writePostForm.addEventListener('submit', function (e) {
    ...
    (0, _writePost.writePost)(form);
  });
} //  === edit a post


var editPostButton = document.querySelector('.edit-post');

if (editPostButton) {
  editPostButton.addEventListener('click', function (e) {
    e.preventDefault();
    var link = window.location.href + '/edit';
...
if (editPostForm) {
  var urls = window.location.href.split('?')[0].replace('/edit', '');
  editPostForm.addEventListener('submit', function (e) {
    ...
    form.append('description', tinymce.get('mytextarea').getContent());
    form.append('image', document.querySelector('#image').files[0]);
    (0, _editPost.editPost)(form, urls);
  });
} // delete reviews


var deletePosts = document.querySelector('.delete-post');

if (deletePosts) {
  deletePosts.addEventListener('click', function (e) {
    e.preventDefault();
    var postId = deletePosts.getAttribute('data-post-id');
    (0, _deletePost.deletePost)(postId);
  });
} // Page navigation
...
if (previousButton && nextButton) {
  var userUrl = String(window.location.href);
  var cookTime;

  var sort = function sort(time) {
    if (userUrl.includes(time)) {
      cookTime = "cookTime=".concat(time, "&");
    }
  };
  ...
  var next = function next(e) {
    e.preventDefault();
    var address = cookTime ? "/posts?".concat(cookTime, "page=").concat(nextButtonValue + 1) : "/posts?page=".concat(nextButtonValue + 1);
    window.location.href = address;
  };

  var previous = function previous(e) {
    e.preventDefault();
    var address = cookTime ? "/posts?".concat(cookTime, "page=").concat(previousButtonValue - 1) : "/posts?page=".concat(previousButtonValue - 1);
    window.location.href = address;
  };

  var pageNumber = Number(window.location.href.split('page=')[1]);
  var nextButtonValue = pageNumber || 1;
  ...
  var previousButtonValue = pageNumber > 1 ? pageNumber : 2;
