...
// const submenuHome = document.querySelectorAll(
//   '.home > .submenu, .home > .submenu-link'
// )
// const submenuChildren = Array.from(
//   document.querySelector('.navbar').children[0].children
// )
// const submenuBusiness = document.querySelectorAll(
//   '.business > .submenu, .business > .submenu-link'
// )
...
// const businessPanelSelector = document.querySelectorAll(
//   '.business-panel-selector'
// )
// const downloadLink = document.querySelector('#download-link')
// const submenuDownload = document.querySelectorAll(
//   '.download > .submenu, .download > .submenu-link'
// )
...
//         if (navPanel) {
//           const panelName = Array.from(this.classList)
//             .find((value) => /selector$/.test(value))
//             .replace(/-selector/g, '')
...
//     if (el.classList[0] !== nav) siblingsClassName.push(el.classList[0])
//   }
//   for (el of siblingsClassName) {
//     if (document.querySelector(`.${el}`).children[1]) {
//       const siblingsChildrenClassName = el
//       const disableSiblingMenu = document.querySelectorAll(
//         `.${siblingsChildrenClassName} > .submenu, .${siblingsChildrenClassName} > .submenu-link`
//       )
//       disableSiblingMenu.forEach(function (e) {
//         if (
//           e.classList.contains('submenu-link') &&
//           e.classList.contains('open-menu')
//         ) {
//           e.classList.remove('open-menu')
//           e.classList.add('closed-menu')
//         }
